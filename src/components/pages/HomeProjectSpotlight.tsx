          ...
          <div className="relative grid gap-8 md:grid-cols-[1fr_auto] md:items-center">
            <div>
              <p className="inline-flex items-center rounded-full border border-white/15 bg-white/5 px-3 py-1 text-xs font-semibold uppercase tracking-wide text-indigo-200">
                FlipMyFiles · Open Source
              </p>
              <h2 className="mt-4 text-3xl font-extrabold tracking-tight text-white sm:text-4xl">
                Fully Open Source. No Server Processing. 100% Secure.
              </h2>
              <p className="mt-4 max-w-3xl text-base leading-relaxed text-slate-300 sm:text-lg">
                FlipMyFiles is a fully open-source converter built for privacy-first workflows.
                Your files stay on your device with no server-side processing, giving you maximum control and security.
              </p>
